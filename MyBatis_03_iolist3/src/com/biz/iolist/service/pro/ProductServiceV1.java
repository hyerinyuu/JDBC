...
public class ProductServiceV1 {
	...
	// protected 현재 클래스를 상속받은 곳에서는 viewPDetail()을 사용할 수 있지만 그렇지 않은곳에서는 금지
	
	// extends로 상속받은 곳에서는 public처럼 다른곳에서는 private처럼 작동함.
	
	// 상품코드를 매개변수로 받아서 해당 상품이있으면 상세정보를 보여주고 productDTO를 return하고
	// 그렇지 않으면 null값을 return
