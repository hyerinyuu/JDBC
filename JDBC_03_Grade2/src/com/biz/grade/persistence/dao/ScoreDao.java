...
/*
 * [Service 클래스] : CRUD를 주로 수행하는 CLASS
 *	  main() 호출하여 다양한 연산을 수행하는 용도
 *	 file읽, file쓰기, file읽은 후 연산처리
 * 	 JDBC 연결하여 데이터 연동
 * 
 * 
 * [DAO 클래스] (Data Access Object(DB 접근 객체))
 ...
 *  
 *  [MVC 패턴] : 클래스들을 잘게 쪼개서 각각의 클래스가 다른 역할을 수행하도록 디자인 한 것
 *  main() <-> service <-> DAO <-> DBMS
 *  view		view
 *  /----------DTO, VO----------------/
 *  Controller : main과 Service간 연산을 수행하는 장치
 * 
 */
